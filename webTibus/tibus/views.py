...
def linea(request):#pagina de ABM de lineas
    ...
    elif (datosUsuario.categoria == 'Linea'):
    ...
    #logica
    if (datosUsuario.categoria == 'System' or datosUsuario.categoria == 'Linea'):
        if request.method == 'POST':
            try:
